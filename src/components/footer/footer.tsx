...
const Footer = component$(() => {
    return (
        <>
            {/* <footer class="w-full h-[550px] bg-black text-white">
            <div class="max-w-[1440px] p-2 m-auto">
                <section class="flex justify-between items-center">
                    <div class="image">
                        <img width={100} height={100} src={xiome14ultra} alt="xiome14ultra" />
                    </div>
                    <div class="contact">
                        <h4>Contact Us</h4>
                        <p>jafrulstc@gmail.com</p>
                    </div>
                ...
                <section class="flex justify-between">
                    <div class="web-info flex justify-between p-2">
                        <div class="about">
                        ...
                        <div class="Ppolicy">
                            <h2 class="text-red-500">Policy</h2>
                            <ul>
                        ...
                        <div class="product-delivery">
                            <h2 class="text-red-500">Product Delivery</h2>
                            <ul>
                        ...
                        <div class="acategorybout">
                            <h2 class="text-red-500">Category</h2>
                            <ul>
                                <li>Trimmer</li>
                                <li>Hair Dryer</li>
                                <li>Used</li>
                    ...
                    <div class="social">
                        <div class="social-icon">
                            <IconFacebook svgStyle="w-6 h-6 hover:text-primary pointer"/>
                            <IconYoutube svgStyle="w-6 h-6 hover:text-primary pointer" />
                            <IconLinkeDin svgStyle="w-6 h-6 hover:text-primary pointer" />
                            <IconTiktok svgStyle="w-6 h-6 hover:text-primary pointer" />
                            <IconInstagram svgStyle="w-6 h-6 hover:text-primary pointer" />
                        </div>
                        <button class="w-64 bg-primary p-2 rounded-lg text-2xl text-white">STORE LOCATOR</button>
                    </div>
                </section>
            </div>
        </footer> */}

            <footer class="w-full h-auto bg-black text-white">
                <div class="max-w-[1440px] p-4 m-auto">
                    ...
                    <section class="flex flex-wrap sm:flex-nowrap justify-between items-center gap-4">
                        <div class="image flex justify-center sm:justify-start">
                            <img width="100" height="100" class="w-20 h-20 sm:w-[100px] sm:h-[100px]" src={xiome14ultra} alt="xiome14ultra" />
                        </div>
                    ...
                    <section class="flex flex-wrap sm:flex-nowrap justify-between gap-8 mt-8">
                        <div class="web-info grid grid-cols-2 sm:grid-cols-4 gap-4">
                            <div class="about">
                                <h2 class="text-red-500 text-sm sm:text-lg font-semibold">About Us</h2>
                            ...
                            <div class="Ppolicy">
                                <h2 class="text-red-500 text-sm sm:text-lg font-semibold">Policy</h2>
                                <ul class="text-xs sm:text-sm">
                                    <li>Privacy Policy</li>
                                    <li>EMI Policy</li>
                                    <li>Warranty Policy</li>
                            ...
                            <div class="product-delivery">
                                <h2 class="text-red-500 text-sm sm:text-lg font-semibold">Product Delivery</h2>
                                <ul class="text-xs sm:text-sm">
                                    <li>Delivery and Return</li>
                                    <li>Refund and Return Policy</li>
                                    <li>Order Tracking</li>
                            ...
                            <div class="acategorybout">
                                <h2 class="text-red-500 text-sm sm:text-lg font-semibold">Category</h2>
                                <ul class="text-xs sm:text-sm">
                                    <li>Trimmer</li>
                                    <li>Hair Dryer</li>
                                    <li>Used</li>
                        ...
                        <div class="social flex flex-col items-center sm:items-end gap-4">
                            ...
                            <button class="w-full sm:w-64 bg-primary p-2 rounded-lg text-sm sm:text-2xl text-white">
                                STORE LOCATOR
                            </button>
                        </div>
                    </section>
